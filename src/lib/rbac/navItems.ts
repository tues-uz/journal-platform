...
export const NAV_ITEMS: NavItemDef[] = [
  ...
  },
  {
    ...
    path: routes.editorial,
    module: "admin_screening",
    roles: ["editorial_staff"],
  },
  {
    icon: ShieldCheck,
    labelKey: "nav.plagiarism",
    path: routes.plagiarism,
    module: "plagiarism",
    roles: ["editorial_staff"],
  },
  {
    icon: Gavel,
    labelKey: "nav.editorialDecision",
    path: routes.editorialDecision,
  ...
  {
    icon: FolderOpen,
    labelKey: "nav.productionFiles",
    path: routes.layoutFiles,
    module: "layout_production",
    roles: ["layout_editor"],
  },
  {
