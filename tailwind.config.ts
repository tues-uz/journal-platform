    ...
    theme: {
        ...
        extend: {
            ...
            animation: {
                ...
                "hero-fade-up": "hero-fade-up 0.8s ease-out both",
                "hero-fade-up-delayed": "hero-fade-up 0.9s ease-out 0.08s both",
                "hero-image-zoom": "hero-image-zoom 18s ease-out both",
            },
        },
    },
    plugins: [animate],
